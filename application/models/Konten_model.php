...
class Konten_model extends CI_Model
{
	...
	{
		$data = array(
			'judul_mp3' => $this->input->post('judul', true),
	...
	{
		$data = array(
			'judul_vidio' => $this->input->post('judul', true),
			'embed' => $this->input->post('embed', true),
			'tanggal' => date("l, d-M-Y H:i:s")
		);
	...
	public function tambah_prespective()
	{
		...
		// ========================= Batas Upload File =======================================
		$data = array(
			'judul_status' => $this->input->post('judul_status', true),
