  ...
  <div class="row">
    <div class="col-md-8 blog-main">
      ...
      <ul class="list-unstyled">
        <li class="media">
          <img src="<?= base_url(); ?>asset/img/tumb/<?php echo $konten[8]['gambar']; ?>"
            class="mr-3 rounded"
            alt="..."
        ...
        <li class="media my-4">
          <img src="<?= base_url(); ?>asset/img/tumb/<?php echo $konten[9]['gambar']; ?>"
            class="mr-3 rounded"
            alt="..."
            style="width:80px; height:80px; object-fit:cover;">
          <div class="media-body">
        ...
        <li class="media">
          <img src="<?= base_url(); ?>asset/img/tumb/<?php echo $konten[10]['gambar']; ?>"
            class="mr-3 rounded"
            alt="..."
            style="width:80px; height:80px; object-fit:cover;">
          <div class="media-body">
      ...
      <ul class="list-unstyled">
        <li class="media">
          <img src="<?= base_url(); ?>asset/img/tumb/<?php echo $konten[11]['gambar']; ?>"
            class="mr-3 rounded"
            alt="..."
            style="width:80px; height:80px; object-fit:cover;">
          <div class="media-body">
        ...
        <li class="media my-4">
          <img src="<?= base_url(); ?>asset/img/tumb/<?php echo $konten[12]['gambar']; ?>"
            class="mr-3 rounded"
            alt="..."
            style="width:80px; height:80px; object-fit:cover;">
          <div class="media-body">
        ...
        <li class="media">
          <img src="<?= base_url(); ?>asset/img/tumb/<?php echo $konten[13]['gambar']; ?>"
            class="mr-3 rounded"
            alt="..."
            style="width:80px; height:80px; object-fit:cover;">
          <div class="media-body">
