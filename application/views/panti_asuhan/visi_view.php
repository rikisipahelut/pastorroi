<!-- bagian Halaman Utama -->
      ...
      <!-- <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
        <div class="col-md-6 px-0">
          <h1 class="display-4 font-italic">Panti Asuhan Batu Penjuru Bali</h1>
    ...
    <main role="main" class="container">
      <div class="row">
        <div class="col-md-12 blog-main">
          ...
          <div class="row">
            <div class="col">
              <h3 class="text-center text-dark">Visi Misi Panti Asuhan Batu Penjuru Bali</h3>
            </div>
          </div>
          <div class="row p-5">
              ...
              <div class="blog-post">
                  ...
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">Mengurangi angka anak putus sekolah serta membina dan menyantuni anak-anak kurang mampu,Membuka suatu lembaga yang besar untuk menampung,mendidik dan membina anak-anak putus sekolah</p>
