<!-- bagian Halaman Utama -->
      ...
      <!-- <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
        <div class="col-md-6 px-0">
          <h1 class="display-4 font-italic">Panti Asuhan Batu Penjuru</h1>
    ...
    <main role="main" class="container">
      <div class="row">
        <div class="col-md-12 blog-main">
          ...
          <div class="row">
            <div class="col">
              <h3 class="text-center text-dark">Jumlah Anak</h3>
            </div>
          </div>
          <div class="row p-5">
            <div class="col-md-12 cen">
              <div class="blog-post">
                  ...
                  <div class="card mb-3">
                    <img class="card-img-top" src="<?php echo base_url();?>asset/img/tumb/ypi_negara.jpg" alt="Card image cap" height="300px">
                    <div class="card-body">
                      <h5 class="card-title">Jumlah Anak</h5>
                      <p class="card-text">Jumlah Anak : 26 Orang</p>
                      <p class="card-text">Laki-Laki   : 14 Orang</p>
                      <p class="card-text">Perempuan   : 12 Orang</p>
                      <p class="card-text">SD          : 7 Orang</p>
                      <p class="card-text">SMP         : 9 Orang</p>
                      <p class="card-text">SMA         : 9 Orang</p>
                      <p class="card-text">Universitas : 1 Orang</p>
