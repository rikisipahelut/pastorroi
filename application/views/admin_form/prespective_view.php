          ...
          <div class="col-lg-8">
            ...
            <!-- <form action="" method="post"> -->
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" name="judul_status" class="form-control" id="judul" placeholder="Entry Title">
           <small class="form-text text-danger"><?= form_error('judul_status');?></small>
			  </div>
        <div class="form-group">
          <label for="status">Status</label>
          <input type="text" name="status" class="form-control" id="judul" placeholder="Max 100 Char">
